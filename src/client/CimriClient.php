...
class CimriClient
{
    ...
    public function __construct()
    {
        ...
        $options = [
            ...
            CURLOPT_TIMEOUT => 900,
            CURLOPT_HEADER => [
                'Authorization: ' . getenv('CIMRI_AUTH_TOKEN'),
    ...
    public function SyncProductList($xml)
    {
        ...
        if (curl_errno($this->client)) {
            return $this->responseService->Send(422, false, 'CIMRI_CLIENT_FAILED', null);
        }

        return $this->responseService->Send(201, true, 'CIMRI_CLIENT_SUCCESS', null);
    }
}